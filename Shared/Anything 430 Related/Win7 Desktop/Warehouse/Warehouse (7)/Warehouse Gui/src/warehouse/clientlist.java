...
public class clientlist extends JFrame{
    ...
    String [] columnNames = {"Client ID", "First Name", "Last Name", "Phone Number", "Email Address"};
    Object [] [] data = {{"00649256", "kunga", "sherpa", "5072790256" ,"kungasherpa@gmail.com"}};


    public clientlist(int a)
    {
