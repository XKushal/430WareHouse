...
//userButton.addActionListener(this);
    ...
    private void manager() {
        String userID = JOptionPane.showInputDialog(loginFrame, "Please input manager username: (DEBUG: Enter 'manager')");
        String password = JOptionPane.showInputDialog(loginFrame, "Enter Password (DEBUG: Enter 'manager')");
    ...
    private void sales() {
        String userID = JOptionPane.showInputDialog(
                loginFrame, "Please input sales username: (DEBUG: Enter 'salesclerk')");

        String password = JOptionPane.showInputDialog(loginFrame, "Enter Password (DEBUG: Enter 'salesclerk')");
    ...
    private void client() {
        String userID = JOptionPane.showInputDialog(loginFrame, "Please input the user id: (DEBUG: Enter C1, C2)");
        if (Warehouse.instance().findClient(userID) == true) {
            String password = JOptionPane.showInputDialog(loginFrame, "Enter Password (DEBUG: Enter id itself)");
